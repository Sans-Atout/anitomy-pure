//! File extension detection using a static set of known media and non-media extensions.
use std::{collections::HashSet, path::Path, sync::LazyLock};

static VALID_EXTENSIONS: LazyLock<HashSet<&'static str>> = LazyLock::new(|| {
    [
        ".php", ".html", ".txt", ".htm", ".aspx", ".asp", ".js", ".css",
        ".pgsql.txt", ".mysql.txt", ".pdf", ".cgi", ".inc", ".gif", ".jpg",
        ".swf", ".xml", ".cfm", ".xhtml", ".wmv", ".zip", ".axd", ".gz",
        ".png", ".doc", ".shtml", ".jsp", ".ico", ".exe", ".csi", ".inc.php",
        ".config", ".jpeg", ".ashx", ".log", ".xls", ".old", ".mp3", ".com",
        ".tar", ".ini", ".asa", ".tgz", ".PDF", ".flv", ".php3", ".bak",
        ".rar", ".asmx", ".xlsx", ".page", ".phtml", ".dll", ".JPG", ".asax",
        ".msg", ".pl", ".GIF", ".ZIP", ".csv", ".css.aspx", ".JPEG", ".ppt",
        ".nsf", ".Pdf", ".Gif", ".bmp", ".sql", ".Jpeg", ".Jpg", ".xml.gz",
        ".Zip", ".new", ".avi", ".psd", ".rss", ".wav", ".action", ".db",
        ".dat", ".do", ".xsl", ".class", ".mdb", ".include", ".cs",
        ".class.php", ".htc", ".mov", ".tpl", ".js.php", ".mysql-connect",
        ".mpg", ".rdf", ".rtf", ".ascx", ".mvc", ".1.0", ".files", ".master",
        ".jar", ".vb", ".mp4", ".local.php", ".fla", ".require", ".de",
        ".docx", ".php5", ".wci", ".readme", ".cfg", ".aspx.cs", ".cfc",
        ".dwt", ".ru", ".LCK", ".Config", ".gif_var_DE", ".html_var_DE",
        ".net", ".ttf", ".HTM", ".X-AOM", ".jhtml", ".mpeg", ".ASP", ".LOG",
        ".X-FANCYCAT", ".php4", ".readme_var_DE", ".vcf", ".X-RMA",
        ".X-AFFILIATE", ".X-OFFERS", ".X-AFFILIATE_var_DE", ".X-AOM_var_DE",
        ".X-FANCYCAT_var_DE", ".X-FCOMP", ".X-FCOMP_var_DE", ".X-GIFTREG",
        ".X-GIFTREG_var_DE", ".X-MAGNIFIER", ".X-MAGNIFIER_var_DE",
        ".X-OFFERS_var_DE", ".X-PCONF", ".X-PCONF_var_DE", ".X-RMA_var_DE",
        ".X-SURVEY", ".tif", ".dir", ".json", ".6.9", ".Zif", ".wma", ".mid",
        ".rm", ".aspx.vb", ".tar.gz", ".woa", ".main", ".ram", ".opml",
        ".0.html", ".css.php", ".feed", ".lasso", ".6.3", ".shtm", ".sitemap",
        ".scc", ".tmp", ".backup", ".sln", ".org", ".conf", ".mysql-query",
        ".session-start", ".uk", ".TXT", ".orig", ".settings.php", ".cab",
        ".kml", ".lck", ".pps", ".require-once", ".asx", ".bok", ".msi",
        ".c", ".fcgi", ".fopen", ".html.", ".phpmailer.php", ".bin",
        ".htaccess", ".info", ".java", ".jsf", ".tmpl", ".DOC", ".bat",
        ".com.html", ".print", ".resx", ".ics", ".php.php", ".x", ".PNG",
        ".data", ".dcr", ".enfinity", ".html.html", ".licx", ".mno", ".plx",
        ".vm", ".5.php", ".HTML", ".MP3", ".config.php", ".dwg", ".edu",
        ".search", ".static", ".wws", ".6.edu", ".OLD", ".bz2", ".co.uk",
        ".ece", ".epc", ".getimagesize", ".ice", ".it_Backup_Giornaliero",
        ".it_Backup_Settimanale", ".jspa", ".lst", ".php-dist", ".svc",
        ".vbs", ".1.html", ".30-i486", ".ai", ".cur", ".dmg", ".img", ".inf",
        ".seam", ".smtp.php", ".1-bin-Linux-2.0.30-i486", ".7z", ".ajax",
        ".cfm.cfm", ".chm", ".csp", ".edit", ".file", ".gif.php", ".m3u",
        ".psp", ".py", ".sh", ".test", ".zdat", ".admin", ".captcha.aspx",
        ".dev", ".eps", ".file-get-contents", ".fr", ".fsockopen", ".list",
        ".m4v", ".min.js", ".new.html", ".p", ".store", ".webinfo",
        ".xml.php", ".BAK", ".htm.", ".php.bak", ".bk", ".bsp", ".cms",
        ".csshandler.ashx", ".d", ".html,", ".htmll", ".idx", ".images",
        ".jad", ".master.cs", ".prev_next", ".ssf", ".stm", ".txt.gz",
        ".Web.UI.WebResource.axd", ".as", ".asp.asp", ".au", ".cnf",
        ".dhtml", ".enu", ".html.old", ".include-once", ".lock", ".m",
        ".mysql-select-db", ".phps", ".pm", ".pptx", ".sav",
        ".sendtoafriendform", ".ssi", ".suo", ".vbproj", ".wml", ".xsd",
        ".26.13.391N35.50.38.816", ".26.24.165N35.50.24.134",
        ".26.56.247N35.52.03.605", ".27.02.940N35.49.56.075",
        ".27.15.919N35.52.04.300", ".27.29.262N35.47.15.083", ".3gp",
        ".40.00.573N35.42.57.445", ".43.58.040N35.38.35.826",
        ".44.04.344N35.38.35.077", ".44.08.714N35.39.08.499",
        ".44.10.892N35.38.49.246", ".44.27.243N35.41.29.367",
        ".44.29.976N35.37.51.790", ".44.32.445N35.36.10.206",
        ".44.34.800N35.38.08.156", ".44.37.128N35.40.54.403",
        ".44.40.556N35.40.53.025", ".44.45.013N35.38.36.211",
        ".44.46.104N35.38.22.970", ".44.48.130N35.38.25.969",
        ".44.52.162N35.38.50.456", ".44.58.315N35.38.53.455",
        ".45.01.562N35.38.38.778", ".45.04.359N35.38.39.112",
        ".45.06.789N35.38.22.556", ".45.10.717N35.38.41.989",
        ".ASPX", ".JS", ".PHP", ".array-keys", ".atom", ".award", ".bkp",
        ".crt", ".default", ".eml", ".epl", ".fancybox", ".fil", ".geo",
        ".h", ".hmtl", ".html.bak", ".ida", ".implode", ".index.php", ".iso",
        ".kmz", ".mysql-pconnect", ".php.old", ".php.txt", ".rec",
        ".storefront", ".taf", ".war", ".xslt", ".1.6", ".2a", ".8.1",
        ".CSS", ".NSF", ".Sponsors", ".a", ".aquery", ".ascx.cs", ".cat",
        ".contrib", ".ds", ".dwf", ".film", ".g", ".go", ".googlebook",
        ".gpx", ".hotelName", ".htm.htm", ".ihtml", ".in-array", ".index",
        ".ini.php", ".layer", ".maninfo", ".odt", ".price", ".randomhouse",
        ".read", ".ru-tov.html", ".s7", ".sample", ".sit", ".src",
        ".tpl.php", ".trck", ".uguide", ".vorteil", ".wbp", ".2.html",
        ".AVI", ".Asp", ".EXE", ".WMV", ".asax.vb", ".aspx.aspx", ".btr",
        ".cer", ".common.php", ".de.html", ".html\u{200e}", ".jbf", ".lbi",
        ".lib.php", ".lnk", ".login", ".login.php", ".mhtml", ".mpl", ".mso",
        ".mysql-result", ".original", ".pgp", ".ph", ".php.", ".preview",
        ".preview-content.php", ".search.htm", ".site", ".text", ".view",
        ".3.html", ".4.html", ".5.html", ".ICO", ".Web", ".XLS", ".action2",
        ".asc", ".asp.bak", ".aspx.resx", ".browse", ".code",
        ".com_Backup_Giornaliero", ".com_Backup_Settimanale", ".csproj",
        ".dtd", ".en.html", ".ep", ".eu", ".form", ".html1", ".inc.asp",
        ".index.html", ".it", ".nl", ".ogg", ".old.php", ".old2", ".opendir",
        ".out", ".pgt", ".php,", ".php\u{200e}", ".po", ".prt", ".query",
        ".rb", ".rhtml", ".ru.html", ".save", ".search.php", ".t", ".wsdl",
        ".0-to1.2.php", ".CFM", ".MOV", ".MPEG", ".Master", ".PPT", ".TTF",
        ".Templates", ".XML", ".adp", ".ajax.php", ".apsx", ".asf", ".bck",
        ".bu", ".calendar", ".captcha", ".cart", ".com.crt", ".core",
        ".dict.php", ".dot", ".egov", ".en.php", ".eot", ".errors", ".f4v",
        ".fr.html", ".git", ".ht", ".hta", ".html.LCK", ".html.printable",
        ".ini.sample", ".lib", ".lic", ".map", ".master.vb", ".mi", ".mkdir",
        ".o", ".p7b", ".pac", ".parse.errors", ".pd", ".pfx", ".php2",
        ".php_files", ".phtm", ".png.php", ".portal", ".printable", ".psql",
        ".pub", ".q", ".ra", ".reg", ".restrictor.php", ".rpm", ".strpos",
        ".tcl", ".template", ".tiff", ".tv", ".us", ".user", ".Controls",
        ".WAV", ".acgi", ".alt", ".array-merge", ".back",
        ".call-user-func-array", ".cfml", ".cmd", ".cocomore.txt", ".detail",
        ".disabled", ".dist.php", ".djvu", ".dta", ".e", ".extract",
        ".file-put-contents", ".fpl", ".framework", ".fread", ".htm.LCK",
        ".inc.js", ".includes", ".jp", ".jpg.html", ".l", ".letter", ".local",
        ".num", ".pem", ".php.sample", ".php}", ".php~", ".pot",
        ".preg-match", ".process", ".ps", ".r", ".raw", ".rc", ".s",
        ".search.", ".server", ".sis", ".sql.gz", ".squery", ".subscribe",
        ".svg", ".svn", ".thtml", ".tpl.html", ".ua", ".vcs", ".xhtm",
        ".xml.asp", ".xpi", ".A", ".PAGE", ".SWF", ".add", ".array-rand",
        ".asax.cs", ".asax.resx", ".ascx.vb", ".aspx,", ".aspx.", ".awm",
        ".b", ".bhtml", ".bml", ".ca", ".cache", ".cfg.php", ".cn", ".cz",
        ".de.txt", ".diff", ".email", ".en", ".error", ".faces", ".filesize",
        ".functions.php", ".hml", ".hqx", ".html,404", ".html.php",
        ".htmls", ".htx", ".i", ".idq", ".jpe", ".js.aspx", ".js.gz",
        ".jspf", ".load", ".media", ".mp2", ".mspx", ".mv", ".mysql",
        ".new.php", ".ocx", ".oui", ".outcontrol", ".pad", ".pages", ".pdb",
        ".pdf.", ".pnp", ".pop_formata_viewer", ".popup.php",
        ".popup.pop_formata_viewer", ".pvk", ".restrictor.log", ".results",
        ".run", ".scripts", ".sdb", ".ser", ".shop", ".sitemap.xml", ".smi",
        ".start", ".ste", ".swf.swf", ".templates", ".textsearch", ".torrent",
        ".unsubscribe", ".v", ".vbproj.webinfo", ".web", ".wmf", ".wpd",
        ".ws", ".xpml", ".y", ".AdCode", ".Aspx", ".C.", ".COM",
        ".GetMapImage", ".Html", ".Run.AdCode", ".Skins", ".Z",
        ".access.login", ".ajax.asp", ".app", ".asd", ".asm", ".assets",
        ".at", ".bad", ".bak2", ".blog", ".casino", ".cc", ".cdr",
        ".changeLang.php", ".children", ".com,", ".com-redirect", ".content",
        ".copy", ".count", ".cp", ".csproj.user", ".custom", ".dbf", ".deb",
        ".delete", ".details.php", ".dic", ".divx", ".download",
        ".download.php", ".downloadCirRequirements.pdf",
        ".downloadTourkitRequirements.pdf", ".emailCirRequirements.php",
        ".emailTourkitForm.php", ".emailTourkitNotification.php",
        ".emailTourkitRequirements.php", ".epub", ".err", ".es", ".exclude",
        ".filemtime", ".fillPurposes2.php", ".grp", ".home", ".htlm",
        ".htm,", ".html-", ".image", ".inc.html", ".it.html", ".j", ".jnlp",
        ".js.asp", ".js2", ".jspx", ".lang-en.php", ".link", ".listevents",
        ".log.0", ".mbox", ".mc_id", ".menu.php", ".mgi", ".mod",
        ".net.html", ".news", ".none", ".off", ".p3p", ".php.htm",
        ".php.static", ".php1", ".phpp", ".pop3.php", ".pop_3D_viewer",
        ".popup.pop_3D_viewer", ".prep", ".prg", ".print.html", ".print.php",
        ".product_details", ".pwd", ".pyc", ".red", ".registration",
        ".requirementsFeesTable.php", ".roshani-gunewardene.com", ".se",
        ".sea", ".sema", ".session", ".setup", ".simplexml-load-file",
        ".sitx", ".smil", ".srv", ".swi", ".swp", ".sxw", ".tar.bz2",
        ".tem", ".temp", ".template.php", ".top", ".txt.php", ".types",
        ".unlink", ".url", ".userLoginPopup.php", ".visaPopup.php",
        ".visaPopupValid.php", ".vspscc", ".vssscc", ".w", ".work", ".wvx",
        ".xspf", ".-", ".Admin", ".E.", ".Engineer", ".INC", ".LOG.new",
        ".MAXIMIZE", ".MPG", ".NDM", ".Php", ".R", ".SIM", ".SQL",
        ".Services", ".[file", ".accdb", ".act", ".actions.php",
        ".admin.php", ".ads", ".alhtm", ".all", ".ani", ".apf", ".apj",
        ".ar", ".aral-design.com", ".aral-design.de", ".arc",
        ".array-key-exists", ".asp.old", ".asp1", ".aspg", ".bfhtm",
        ".biminifinder", ".br", ".browser", ".build", ".buscar",
        ".categorias", ".categories", ".ccs", ".ch", ".cl", ".click.php",
        ".cls", ".cls.php", ".cms.ad.AdServer.cls", ".com-tov.html",
        ".com.ar", ".com.br", ".com.htm", ".com.old", ".common",
        ".conf.php", ".contact.php", ".control", ".core.php",
        ".counter.php", ".coverfinder", ".create.php", ".cs2", ".d2w",
        ".dbm", ".dct", ".dmb", ".doc.doc", ".dxf", ".ed", ".email.shtml",
        ".en.htm", ".engine", ".env", ".error-log", ".esp", ".ex", ".exc",
        ".exe,", ".ext", ".external", ".ficheros", ".fichiers", ".flush",
        ".fmt", ".fn", ".footer", ".form_jhtml", ".friend", ".g.",
        ".geo.xml", ".ghtml", ".google.com", ".gov", ".gpg", ".hl",
        ".href", ".htm.d", ".htm.html", ".htm.old", ".htm2", ".html.orig",
        ".html.sav", ".html[", ".html]", ".html_", ".html_files",
        ".htmlpar", ".htmlprint", ".html}", ".htm~", ".hts", ".hu", ".hwp",
        ".ibf", ".il", ".image.php", ".imagecreatetruecolor", ".imagejpeg",
        ".iml", ".imprimer", ".imprimer-cadre", ".imprimir",
        ".imprimir-marco", ".info.html", ".info.php", ".ini.bak",
        ".ini.default", ".inl", ".inv", ".join", ".jpg.jpg", ".jps",
        ".key", ".kit", ".lang", ".lignee", ".ltr", ".lzh", ".m4a",
        ".mail", ".manager", ".md5", ".met", ".metadesc", ".metakeys",
        ".mht", ".min", ".mld", ".mobi", ".mobile", ".mv4", ".n",
        ".net-tov.html", ".nfo", ".nikon", ".nodos", ".nxg", ".obyx",
        ".ods", ".old.2", ".old.asp", ".old.html", ".open", ".opml.config",
        ".ord", ".org.zip", ".ori", ".partfinder", ".pho", ".php-",
        ".phpl", ".phpx", ".pix", ".pls", ".prc", ".pre", ".prhtm",
        ".print-frame", ".print.", ".print.shtml", ".printer",
        ".properties", ".propfinder", ".pvx", ".recherche", ".redirect",
        ".req", ".roshani-gunewardene.net", ".roshani-m-gunewardene.com",
        ".safe", ".sbk", ".se.php", ".search.asp", ".sec", ".seo", ".serv",
        ".server.php", ".servlet", ".settings", ".sf",
        ".shopping_return.php", ".shopping_return_adsense.php", ".show",
        ".sht", ".skins", ".so", ".sph", ".split", ".sso", ".stats.php",
        ".story", ".swd", ".swf.html", ".sys", ".tex", ".tga", ".thm",
        ".tlp", ".tml", ".tmp.php", ".touch", ".tsv", ".txt.", ".txt.html",
        ".ug", ".unternehmen", ".utf8", ".vbproj.vspscc", ".vsprintf",
        ".vstemplate", ".vtl", ".wbmp", ".webc", ".webproj", ".wihtm",
        ".wp", ".wps", ".wri", ".wsc", ".www", ".xsp", ".xsql", ".zip,",
        ".zml", ".ztml", ". EXTRAHOTELERO HOSPEDAJE", ". T.", ". php",
        ".,", ".a5w", ".aac", ".access", ".act.php", ".action.php",
        ".actions", ".activate.php", ".ad.php", ".add.php",
        ".adenaw.com", ".adm", ".advsearch", ".ag.php", ".aj_",
        ".all.hawaii", ".amaphun.com", ".andriy.lviv.ua", ".ap", ".api",
        ".apk", ".application", ".archiv", ".arj", ".array-map",
        ".array-values", ".art", ".artdeco", ".articlePk", ".artnet.",
        ".ascx.resx", ".asia", ".asp-", ".asp.LCK", ".asp.html", ".asp2",
        ".aspDONOTUSE", ".asp_", ".asp_files", ".aspl", ".aspp", ".asps",
        ".aspx.designer.cs", ".aspx_files", ".aspxx", ".aspy", ".asxp",
        ".at.html", ".avatar.php", ".awstats", ".babymhiasexy.com",
        ".backup.php", ".bak.php", ".banan.se", ".banner.php", ".barnes",
        ".basicmap.php", ".baut", ".bc", ".best-vpn.com", ".beta", ".biz",
        ".blackandmature.com", ".bmp.php", ".board.asd", ".boom",
        ".bossspy.org", ".buscadorpornoxxx.com", ".buy-here.com",
        ".buyadspace", ".bycategory", ".bylocation", ".bz", ".c.html",
        ".cache.inc.php", ".cache.php", ".car", ".cascinaamalia.it",
        ".cat.php", ".catalog", ".cdf", ".ce", ".cfm.bak",
        ".cfsifatest.co.uk", ".cfstest.co.uk", ".cfswf", ".cfx", ".cgis",
        ".chat", ".chdir", ".chloesworld.com", ".classes.php", ".cmp",
        ".cnt", ".co", ".co-operativebank.co.uk",
        ".co-operativebanktest.co.uk", ".co-operativeinsurance.co.uk",
        ".co-operativeinsurancetest.co.uk",
        ".co-operativeinvestmentstest.co.uk", ".co.il",
        ".colorbox-min.js", ".com-authorization-required.html",
        ".com-bad-request.html", ".com-forbidden.html",
        ".com-internal-server-error.html", ".com-page-not-found.html",
        ".com.au", ".com.php", ".com.ua", ".com_Backup_", ".com_files",
        ".comments", ".comments.", ".comments.php", ".compiler.php",
        ".conf.html", ".confirm.email", ".connect.php", ".console",
        ".contact", ".content.php", ".controller",
        ".controls-3.1.5.swf", ".cookie.js", ".corp", ".corp.footer",
        ".cqs", ".cron", ".cropcanvas.php", ".cropinterface.php", ".crx",
        ".csproj.webinfo", ".csr", ".css.LCK", ".css.gz", ".cssd",
        ".csv.php", ".ctp", ".cx", ".cycle.all.min.js", ".d64", ".daisy",
        ".dal", ".daniel", ".daniel-sebald.de", ".data.php", ".data_",
        ".davis", ".dbml", ".dcf", ".de.jsp", ".default.php", ".del",
        ".deleted", ".dell", ".demo", ".desarrollo.aquihaydominios.com",
        ".dev.bka.co.nz", ".development", ".dig", ".display.php", ".dist",
        ".dk", ".dm", ".dmca-sucks.com", ".dms", ".dnn", ".dogpl",
        ".donothiredandobrin.com", ".dontcopy", ".downloadfreeporn.asia",
        ".du", ".dump", ".dws", ".dyn", ".ea3ny.com", ".easing.min.js",
        ".ebay", ".ebay.results.html", ".editingoffice.com",
        ".efacil.com.br", ".ehtml", ".emaximinternational.com", ".en.jsp",
        ".enn", ".equonix.com", ".es.html", ".es.jsp", ".euforyou.net",
        ".eur", ".excel.xml.php", ".exec", ".exp", ".f.l.",
        ".faucetdepot", ".faucetdepot.com.vbproj",
        ".faucetdepot.com.vbproj.webinfo", ".fb2", ".fdml", ".feeds.php",
        ".ffa", ".ficken.cx", ".filereader", ".filters.php", ".flac",
        ".flypage", ".fon", ".forget.pass", ".form.php", ".forms",
        ".forum", ".found", ".fp7", ".fr.jsp", ".freeasianporn.asia",
        ".freepornxxx.asia", ".frk", ".frontpage.php", ".ft", ".ftl",
        ".fucks.nl", ".funzz.fr", ".gallery.php", ".garcia", ".gb",
        ".get", ".get-meta-tags", ".gif         ", ".gif.count",
        ".girlvandiesuburbs.co.za", ".gitihost.com", ".glasner.ru",
        ".google", ".gray", ".gsp", ".guiaweb.tk", ".gutschein", ".guy",
        ".ha", ".hardestlist.com", ".hardpussy.com", ".hasrett.de",
        ".hawaii", ".header.php", ".henry", ".him", ".history", ".hlr",
        ".hm", ".ho", ".hokkaido", ".hold", ".home.php", ".home.test",
        ".homepage", ".hp", ".htm.bak", ".htm.rc", ".htm3", ".htm5",
        ".htm7", ".htm8", ".htm_", ".html,,", ".html-0", ".html-1",
        ".html-c", ".html-old", ".html-p", ".html.htm", ".html.images",
        ".html.inc", ".html.none", ".html.pdf", ".html.start", ".html.txt",
        ".html4", ".html5", ".html7", ".htmlBAK", ".htmlDolmetschen",
        ".html_old", ".htmla", ".htmlc", ".htmlfeed", ".htmlq", ".htmlu",
        ".htn", ".htpasswd", ".iac.", ".ibuysss.info", ".iconv", ".idf",
        ".iframe_filtros", ".ignore.php", ".ihmtl", ".ihya", ".imp",
        ".in", ".inactive", ".inc.php.bak", ".inc.php3",
        ".incest-porn.sex-startje.nl", ".incestporn.sex-startje.nl",
        ".incl", ".indiansexzite.com", ".indt",
        ".ini.NEWCONFIGPOSSIBLYBROKEN", ".insert",
        ".internet-taxprep.com", ".interpreterukraine.com", ".ipl",
        ".issues", ".itml", ".ixi", ".jhtm", ".job", ".joseph", ".jpf",
        ".jpg.xml", ".jpg[", ".jpg]", ".js,", ".js.LCK", ".jsa", ".jsd",
        ".jso", ".jsp.old", ".jsps", ".jtp", ".keyword",
        ".kinkywear.net", ".kk", ".knvbcommunicator.voetbalassist.nl",
        ".kokuken", ".ks", ".kutxa.net-en", ".lang-de.php", ".lang.php",
        ".langhampartners.com", ".lappgroup.com", ".last", ".latest",
        ".lha", ".links", ".list.includes", ".listMiniGrid", ".listing",
        ".lng", ".loc", ".local.cfm", ".location.href", ".log2", ".lua",
        ".lynkx", ".maastrichtairporthotels.com", ".mag", ".mail.php",
        ".malesextoys.us", ".massivewankers.com", ".mbizgroup", ".mel",
        ".members", ".meretrizdelujo.com", ".messagey.com",
        ".metadata.js", ".meus.php", ".midi", ".milliculture.net",
        ".min_", ".miss-video.com", ".mk.gutschein", ".mk.rabattlp",
        ".mkv", ".mmap", ".model-escorts.asia", ".modelescorts.asia",
        ".mp", ".mp3.html", ".mq4", ".mreply.rc", ".msp", ".mvn",
        ".mysqli", ".napravlenie_ASC", ".napravlenie_DESC",
        ".nded-pga-emial", ".net-en", ".net-print.htm",
        ".net_Backup_Giornaliero", ".net_Backup_Settimanale", ".new.htm",
        ".newsletter", ".nexucom.com", ".ninwinter.net", ".nl.html",
        ".nonude.org", ".nonudes.com", ".nth", ".nz", ".od",
        ".offer.php", ".offline", ".ogv", ".ok", ".old.1", ".old.htm",
        ".old.old", ".old1", ".old3", ".older", ".oliver",
        ".onedigitalcentral.com", ".onenettv.com", ".online",
        ".opensearch", ".org-tov.html", ".org.ua-tov.html", ".orig.html",
        ".origin.php", ".original.html", ".orlando-vacationhome.net",
        ".orlando-vacationhomes-pools.com", ".orlando-vacationrentals.net",
        ".osg", ".outbound", ".owen", ".ownhometest.co.uk", ".pae",
        ".page_pls_all_password", ".pages-medicales.com", ".pan",
        ".parse-url", ".part", ".pass", ".patch", ".paul",
        ".paymethods.php", ".pazderski.com", ".pazderski.net",
        ".pazderski.us", ".pdd", ".pdf.html", ".pdf.pdf", ".pdf.php",
        ".pdfx", ".perfect-color-world.com",
        ".petersburg-apartments-for-business.html",
        ".petersburg-apartments-for-tourists.html",
        ".petersburg-romantic-apartments.html", ".phdo", ".photo",
        ".php--------------", ".php.LCK", ".php.backup", ".php.html",
        ".php.inc", ".php.mno", ".php.original", ".php_", ".php_OLD",
        ".php_old", ".phphp", ".phppar", ".phpvreor.php", ".php", ".pht",
        ".pl.html", ".planetcom.ca", ".playwithparis.com", ".plugins",
        ".png,bmp", ".popup", ".pornfailures.com", ".pornoizlee.tk",
        ".pornz.tv", ".posting.prep", ".prev", ".print.jsp", ".prl",
        ".prosdo.com", ".psb", ".publisher.php", ".puresolo.com",
        ".pussyjourney.com", ".qtgp", ".qxd", ".r.", ".rabattlp",
        ".rails", ".randomocityproductions.com", ".rateart.php",
        ".readfile", ".rec.html", ".redirect.php", ".remove",
        ".remove.php", ".removed", ".resultados", ".resume", ".rhtm",
        ".riddlesintime.com", ".rmvb", ".ro", ".roma", ".roomscity.com",
        ".roshanigunewardene.com", ".rpt", ".rsp", ".rss.php",
        ".rss_cars", ".rss_homes", ".rss_jobs", ".rtfd", ".rvt",
        ".s.html", ".sadopasion.com", ".safariextz", ".salestax.php",
        ".sc", ".sca-tork.com", ".scandir", ".scrollTo.js",
        ".search.html", ".sec.cfm", ".section", ".secure", ".send",
        ".sent-", ".service", ".session-regenerate-id", ".set",
        ".sex-startje.nl", ".sexmeme.com", ".sexon.com",
        ".sexy-girls4abo.de", ".sfw", ".sgf", ".shipcode.php",
        ".shipdiscount.php", ".show.php", ".shtml.html", ".sidebar",
        ".sisx", ".sitemap.", ".skin", ".small-penis-humiliation.net",
        ".smiletest.co.uk", ".snippet.aspx", ".snuffx.com", ".sort",
        ...
        ".sortirovka_name.napravlenie_DESC", ".sp", ".sphp3", ".srch",
        ".srf", ".srvl", ".st-patricks.com", ".sta", ".staged.php",
        ".staging", ".start.php", ".stat", ".stats", ".step", ".stml",
        ".storebanner.php", ".storelogo.php", ".storename.php",
        ".sts.php", ".suarez", ".submit", ".support", ".support.html",
        ".swf.LCK", ".sym", ".system", ".tab-", ".table.html",
        ".tablesorter.min.js", ".tablesorter.pager.js", ".tatianyc.com",
        ".tb", ".tech", ".teen-shy.com", ".teenhardpussy.com",
        ".temp.php", ".templates.php", ".temporarily.withdrawn.html",
        ".test.cgi", ".test.php", ".tf", ".tg", ".thanks",
        ".thehotfish.com", ".theme", ".thompson", ".thumb.jpg",
        ".ticket.submit", ".tim", ".tk", ".tls", ".to", ".touch.action",
        ".trace", ".tracker.ashx", ".trade", ".trishasex.viedos.com",
        ".ts", ".tst", ".tvpi", ".txt.txt", ".txuri-urdin.com", ".ufo",
        ".ugmart.ug", ".ui-1.5.2", ".unixteacher.org", ".unsharp.php",
        ".update", ".upgrade", ".v1.11.js", ".v2.php",
        ".vacationhomes-pools.com", ".var",
        ".venetian.com,prod2.venetian.com,reservations.venetian.com,",
        ".verify", ".video", ".videodeputas.com", ".videos-chaudes.com",
        ".viewpage__10", ".vmdk", ".vn", ".voetbalassist.nl", ".vs",
        ".vx", ".vxlpub", ".w3m", ".w3x", ".wax", ".web-teck.com",
        ".webalizer", ".webarchive", ".webjockey.nl", ".webm",
        ".weedooz.eu", ".wgx", ".wimzi.php", ".wireless",
        ".wireless.action", ".wm", ".woolovers.com", ".working", ".wpl",
        ".wplus", ".wps.rtf", ".write.php", ".wwsec_app_priv.login",
        ".www.annuaire-vimarty.net", ".www.annuaire-web.info",
        ".www.kit-graphik.com", ".www.photo-scope.fr", ".xcam.at",
        ".xconf", ".xcwc.com", ".xgi", ".xhtml5", ".xlt", ".xm",
        ".xml.old", ".xpdf", ".xqy", ".xslx", ".xst", ".xsx",
        ".xy.php", ".yp", ".ys", ".z", ".za", ".zh.html", ".zhtml",
        ".zip.php",
    ]
    .into_iter()
    .collect()
...
fn is_valid_extension(tested_extension: &str) -> bool {
    VALID_EXTENSIONS.contains(tested_extension)
}

/// Strips the file extension from `file_name`, returning the stem.
pub(crate) fn remove_extension(file_name: &str) -> String {
...
/// Returns the file extension of `file_name` if it is a known media format, otherwise `None`.
pub(crate) fn get_extension(file_name: &str) -> Option<String> {
...
#[cfg(test)]
mod tests {
    use super::{get_extension, remove_extension};
    use pretty_assertions::assert_eq;

    #[test]
    fn test_valid_extension() {
        assert!(super::is_valid_extension(".mkv"));
        assert!(super::is_valid_extension(".mp4"));
        assert!(super::is_valid_extension(".avi"));
        assert!(super::is_valid_extension(".html"));
    }
